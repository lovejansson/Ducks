...
export default class Duck extends Sprite {
    ...
    constructor(scene, id, pos, width, height, dna, sex, age) {
        ...
        this.animations.create("sit-n", {frames:  `duck-${sex}-sit`, frameRate: 100000, numberOfFrames: 1, startIdx: 0, loop: true});
        this.animations.create("sit-e", {frames:  `duck-${sex}-sit`, frameRate: 100000, numberOfFrames: 1, startIdx: 1, loop: true});
        this.animations.create("sit-s", {frames:  `duck-${sex}-sit`, frameRate: 100000, numberOfFrames: 1, startIdx: 2, loop: true});
